...
const Blog = () => {
  ...
  return (
    <div className="max-w-4xl px-6 py-6 mx-auto space-y-12 ">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap">
            ...
            <div
              ...
              className="bg-primary p-2 ml-5 rounded-full hover:bg-opacity-30 bg-opacity-20 cursor-pointer text-2xl text-primary transition hover:scale-105 overflow-hidden"
            >
              <MdBookmarkAdd />
            </div>
          </div>
